    ...
    return (
        <View style={styles.bottomMenuContainer}>
            ...
            <TouchableOpacity style={styles.tab} onPress={() => handlePress('AccountScreen')}>
                <Image source={require('../assets/user.png')} style={styles.BottomMenuicon} />
